...
![spark_rdd_physical_plan](../img/spark_rdd_physical_plan.PNG)

If you run the above code, you can find the generated dag in the spark ui in the following figure.

![spark_ui_physical_plan](../img/spark_ui_phyical_plan.PNG)
...
![pyspark_ui_physical_plan](../img/pyspark_word_count_physical_plan.png)
